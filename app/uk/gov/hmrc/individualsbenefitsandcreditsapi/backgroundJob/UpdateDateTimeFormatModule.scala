...
package uk.gov.hmrc.individualsbenefitsandcreditsapi.backgroundJob
...
import uk.gov.hmrc.individualsbenefitsandcreditsapi.cache.CacheRepositoryConfiguration
...
@Singleton
class UpdateDateTimeFormatModule @Inject() (
  ...
  private val lockCollection: MongoCollection[Document] =
    mongo.database.getCollection("ttl-cache-locks")
